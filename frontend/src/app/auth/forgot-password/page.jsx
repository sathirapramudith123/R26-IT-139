    ...
    <div className="flex min-h-[80vh] items-center justify-center px-4">
      <div className="w-full max-w-md">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-slate-500">Enter your email to get a reset token</p>
        </div>
        <div className="card-elevated">
          {sent ? (
            <div className="py-4 text-center space-y-3">
              ...
              <p className="text-sm text-slate-500">If that email exists, a reset token has been generated.</p>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <p className="text-center text-sm text-slate-500"><Link href="/auth/login" className="text-teal-700 hover:underline">Back to Sign In</Link></p>
            </form>
          )}
        </div>
      </div>
