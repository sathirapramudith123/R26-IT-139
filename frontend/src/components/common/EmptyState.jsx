export default function EmptyState({ title = "No data yet", description = "Get started by creating your first record.", icon = "📭", action }) {
  return (
    <div className="flex flex-col items-center justify-center rounded-2xl border border-dashed border-slate-200 bg-white px-8 py-16 text-center dark:border-slate-700 dark:bg-slate-900">
      <div className="mb-4 flex h-16 w-16 items-center justify-center rounded-2xl bg-slate-100 text-4xl dark:bg-slate-800">{icon}</div>
      <h3 className="font-outfit text-lg font-semibold text-slate-800 dark:text-slate-100">{title}</h3>
